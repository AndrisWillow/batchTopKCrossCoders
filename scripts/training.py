...
New:
Modified from https://github.com/jkminder/dictionary_learning
This version includes a new method trainSaeWBuffer
Identical to trainSAE, but loads acts via buffer from two LLMs during training
This way we can run the training without relying on massive HDD full of acts
"""
